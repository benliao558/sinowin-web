...
export const articles: Article[] = [
  ...
  },
  {
    ...
    coverImage: '/assets/uploads/fe16n2-supplychain-rebuild.jpg',
    translations: {
      'zh-Hant': {
  ...
  },
  {
    ...
    category: 'technical',
    coverImage: '/assets/uploads/hre-free-ndfeb-thermal-showdown-120c-150c.jpg',
    translations: {
      'zh-Hant': {
  ...
  },
  {
    ...
    category: 'technical',
    coverImage: '/assets/uploads/magnetic-circuit-design-pot-magnet-secret.jpg',
    translations: {
      'zh-Hant': {
  ...
  },
  {
    ...
    category: 'technical',
    coverImage: '/assets/uploads/ndfeb-end-to-end-process.jpg',
    translations: {
      'zh-Hant': {
  ...
  },
  {
    ...
    category: 'industry',
    coverImage: '/assets/uploads/urban-mining-ndfeb-circular-recycling.jpg',
    translations: {
      'zh-Hant': {
  ...
  },
  {
    ...
    category: 'technical',
    coverImage: '/assets/uploads/why-n52-magnet-cannot-reach-14800-gauss.jpg',
    translations: {
      'zh-Hant': {
