...
export const articles: Article[] = [
  {
    ...
    translations: {
      ...
      vi: {
        ...
        content: `<p>Nam châm NdFeB là nam châm thương mại mạnh nhất, được sử dụng trong xe điện, tuabin gió, điện thoại thông minh và thiết bị chính xác. Tuy nhiên, chúng có điểm yếu nghiêm trọng — dễ bị rỉ sét.</p><h2>1. Mạ kẽm — Giá trị cao cho môi trường nhẹ</h2><p>Độ dày thông thường: 7–15 μm. Hiệu suất phun muối: kẽm đen ~12h, kẽm trắng ~16h, kẽm xanh ~24h, kẽm màu ~48h.</p><h2>2. Ni-Cu-Ni — Tiêu chuẩn công nghiệp</h2><p>Lớp kẹp niken, đồng và niken. Độ dày: 15–21 μm. Đạt 24h NSS tiêu chuẩn; loại cao cấp đạt 48h.</p><h2>3. Lớp phủ Epoxy — Lá chắn cho môi trường khắc nghiệt</h2><p>Độ dày: 10–30 μm. Thường đạt 48–72h+ NSS. Lý tưởng cho điện gió ngoài khơi và ứng dụng ngoài trời.</p>`,
  ...
  },
  {
    ...
    translations: {
      ...
      vi: {
        ...
        content: `<p>Công nghệ HRE-Free đang định hình lại bức tranh nam châm, cung cấp hiệu suất mạnh mẽ ngay cả ở nhiệt độ cao.</p><h2>Tại sao nam châm sợ nhiệt?</h2><ul><li><strong>Tổn thất thuận nghịch</strong>: từ thông giảm khi nhiệt độ tăng và phục hồi hoàn toàn sau khi làm nguội.</li><li><strong>Tổn thất không thuận nghịch</strong>: nếu vượt quá điểm đầu gối, nam châm cần được từ hóa lại.</li></ul>`,
